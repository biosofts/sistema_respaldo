...
<div id="roundrect1" style="position:absolute; overflow:hidden; left:228px; top:2px; width:10px; height:888px; z-index:1"><img border=0 width="100%" height="100%" alt="" src="images/roundrect355696000.gif"></div>
...
<div class="wpmd">
<div><font class="ws16"><B>Modificar CIO existente</B></font></div>
</div></div>

<?php
include_once "conexion.php";
$ids = $_GET['id'];
$consulta="select * from sucursales where id=".$ids; 
		
		$fila = mysqli_fetch_assoc(mysqli_query($conexion,$consulta));
?>
<form name="form1" method="POST" action="modificar_cio_formulario.php" style="margin:0px">
<input name="formtext0" type="text" value="<?php echo $ids;?>"style="position:absolute;width:734px;left:370px;top:149px;z-index:5">
<input name="formtext1" type="text" value="<?php echo $fila['cio'];?>" style="position:absolute;width:734px;left:370px;top:149px;z-index:5">
<input name="formtext2" type="text" value="<?php echo $fila['inmueble'];?>"style="position:absolute;width:734px;left:371px;top:198px;z-index:7">
<input name="formtext3" type="text" value="<?php echo $fila['ciudad'];?>"style="position:absolute;width:258px;left:371px;top:254px;z-index:10">
<input name="formbutton1" type="submit" value="Modificar CIO" style="position:absolute;left:370px;top:313px;z-index:11">
</form>
...
<div id="roundrect2" style="position:absolute; overflow:hidden; left:16px; top:252px; width:204px; height:14px; z-index:12"><img border=0 width="100%" height="100%" alt="" src="images/roundrect355695828.gif"></div>

<div id="roundrect3" style="position:absolute; overflow:hidden; left:16px; top:312px; width:204px; height:14px; z-index:13"><img border=0 width="100%" height="100%" alt="" src="images/roundrect355695812.gif"></div>
...
<div id="roundrect4" style="position:absolute; overflow:hidden; left:17px; top:376px; width:204px; height:14px; z-index:15"><img border=0 width="100%" height="100%" alt="" src="images/roundrect355695781.gif"></div>
...
<div id="roundrect5" style="position:absolute; overflow:hidden; left:16px; top:442px; width:204px; height:14px; z-index:17"><img border=0 width="100%" height="100%" alt="" src="images/roundrect355695750.gif"></div>
...
<div id="roundrect6" style="position:absolute; overflow:hidden; left:17px; top:505px; width:204px; height:14px; z-index:19"><img border=0 width="100%" height="100%" alt="" src="images/roundrect355695718.gif"></div>
...
<div id="roundrect7" style="position:absolute; overflow:hidden; left:20px; top:837px; width:204px; height:14px; z-index:21"><img border=0 width="100%" height="100%" alt="" src="images/roundrect355695687.gif"></div>
